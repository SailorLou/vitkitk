...
#endif
	// Liang: some jpeg2000 images can not import properly since the pixel format here after decode is changed
	// which will cause the data type not match with the data type before decode
	// work around is when we found this problem we use previous pixel format
	if(pixeltype_debug != pixeltype) {
		pixeltype = pixeltype_debug;
	}
...
void CustomGDCMImageIO::InternalReadImageInformation()
{
	// ensure file can be opened for reading, before doing any more work
	std::ifstream inputFileStream;
	// let any exceptions propagate
...
bool CustomGDCMImageIO::CanWriteFile(const char *name)
{
...
void CustomGDCMImageIO::WriteImageInformation()
{}

void CustomGDCMImageIO::Write(const void *buffer)
{
	...
	if(hasIPP) {
		double origin3D[3];
		sscanf_s(tempString.c_str(), "%lf\\%lf\\%lf", &(origin3D[0]), &(origin3D[1]), &(origin3D[2]));
	...
	if(hasIOP) {
		double directions[6];
		sscanf_s(tempString.c_str(), "%lf\\%lf\\%lf\\%lf\\%lf\\%lf", &(directions[0]), &(directions[1]), &(directions[2]),&(directions[3]),&(directions[4]),&(directions[5]));
...
void CustomGDCMImageIO::GetPatientName(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void CustomGDCMImageIO::GetPatientID(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void CustomGDCMImageIO::GetPatientSex(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void CustomGDCMImageIO::GetPatientAge(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void CustomGDCMImageIO::GetStudyID(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void CustomGDCMImageIO::GetPatientDOB(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void CustomGDCMImageIO::GetStudyDescription(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void CustomGDCMImageIO::GetBodyPart(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void CustomGDCMImageIO::GetNumberOfSeriesInStudy(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void CustomGDCMImageIO::GetNumberOfStudyRelatedSeries(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void CustomGDCMImageIO::GetStudyDate(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void CustomGDCMImageIO::GetModality(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void CustomGDCMImageIO::GetManufacturer(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void CustomGDCMImageIO::GetInstitution(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void CustomGDCMImageIO::GetModel(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
void CustomGDCMImageIO::GetScanOptions(char *name)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
bool CustomGDCMImageIO::GetValueFromTag(const std::string & tag, std::string & value)
{
	MetaDataDictionary & dict = this->GetMetaDataDictionary();
...
bool CustomGDCMImageIO::GetLabelFromTag(const std::string & tag,
                                        std::string & labelId)
{
	gdcm::Tag t;
...
void CustomGDCMImageIO::PrintSelf(std::ostream & os, Indent indent) const
{

 ...
 *
 *=========================================================================*/
#ifndef itkCustomGDCMImageIO_h
#define itkCustomGDCMImageIO_h
...
class ITKIOGDCM_EXPORT CustomGDCMImageIO:public ImageIOBase
{
public:
...
protected:
  CustomGDCMImageIO();
  ~CustomGDCMImageIO() ITK_OVERRIDE;
...
private:
  ITK_DISALLOW_COPY_AND_ASSIGN(CustomGDCMImageIO);

...
namespace itk
{
CustomGDCMImageIOFactory::CustomGDCMImageIOFactory()
{
  this->RegisterOverride( "itkImageIOBase",
                          "CustomGDCMImageIO",
                          "Custom GDCM Image IO",
                          1,
                          CreateObjectFunction< CustomGDCMImageIO >::New() );
}

CustomGDCMImageIOFactory::~CustomGDCMImageIOFactory()
{}

const char * CustomGDCMImageIOFactory::GetITKSourceVersion() const
{
  return ITK_SOURCE_VERSION;
}

const char * CustomGDCMImageIOFactory::GetDescription() const
{
...
void ITKIOGDCM_EXPORT GDCMImageIOFactoryRegister__Private(void)
{
  if( ! GDCMImageIOFactoryHasBeenRegistered )
    ...
    CustomGDCMImageIOFactory::RegisterOneFactory();
    }
}

...
void DerivedClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DerivedClass *_t = static_cast<DerivedClass *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject DerivedClass::staticMetaObject = {
    { &ImageGraphicsWindow::staticMetaObject, qt_meta_stringdata_DerivedClass.data,
      qt_meta_data_DerivedClass,  qt_static_metacall, nullptr, nullptr}
};
...
void *DerivedClass::qt_metacast(const char *_clname)
{
    ...
    return ImageGraphicsWindow::qt_metacast(_clname);
}

int DerivedClass::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ImageGraphicsWindow::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)

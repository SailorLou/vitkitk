...
// {
// 	char in_fname[30] = "settings.ini";/*用户输入的要加密的文件名*/
// 	char out_fname[30]= "result.ini";
// 	char pwd[8] ="145678";/*用来保存密码*/
//
//
// }
...
int windowRead(int argc, _TCHAR* argv[])
{
	//if(argc < 3) {
	...
	if(MyDecryptFile(pszDestination, decode, pszPassword))
	{
		_tprintf(
		    TEXT("Encryption of the file %s was successful. \n"),
		    pszSource);
